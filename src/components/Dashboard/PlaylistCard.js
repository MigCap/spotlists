  ...
  render() {
    ...
    return (
      <div className="row justify-content-center no-gutters pb-3 px-md-5">
        ...
        <div className="col-12 col-sm-10 px-4 px-sm-3 pt-3 pt-sm-0 pb-4 pb-sm-0 pr-md-4">
          ...
          <div className="">
            {playlist.songs.map((song, index) => (
              <div className="row pb-1 dashboard-cards-text" key={index}>
                <div className="col-10">
                  <div>
                    <p className="text-muted text-left m-0">{song.trackName}</p>
                    <p className="text-muted text-left text-truncate m-0">
                      <Link
                ...
                <div className="col-2 pl-0 align-self-start">
                  <p className="text-muted text-right m-0 p-0">
